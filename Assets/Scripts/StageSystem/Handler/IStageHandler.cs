...
namespace ARBattle
{
    public abstract class IStageHandler
    {
        ...
        protected virtual void UpdateStage()
        {
            ...
            if (mStageSystem.IsUpdateStageTime)
            {
                EventCenter.Broadcast<float>(EventDefine.UpdateStageTime, mStageData.Total * mStageData.SpawnTime);

                mStageSystem.IsUpdateStageTime = false;
            }
        }
